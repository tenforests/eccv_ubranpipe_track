...
class GroupRandomHorizontalFlip(object):
    ...
    def __init__(self, is_flow=False):
        ...
        self.worker  = torchvision.transforms.RandomHorizontalFlip()
...
class GroupNormalize(object):
    ...
    def __call__(self, tensor):
        ...
        if self.threed_data:
            ...
            # TODO: make efficient
            torchvision.transforms.Normalize(rep_mean,rep_std,tensor)
...
class Stack(object):
    ...
    def __call__(self, img_group):
        torch.tensor([img.numpy() for img in img_group])
        # for img in img_group:
        ...
        img_group = rearrange(img_group,'f c h w  -> (f c) h w ')
        return img_group
...
class ToTorchFormatTensor(object):
    ...
    def __call__(self, pic):
        ...
        return pic.float().div(255) if self.div else pic.float()
