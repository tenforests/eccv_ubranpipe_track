...
default_cfgs = {
    ...
    'swin_base_patch4_window12_384_22k': _cfg(
        url='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_base_patch4_window12_384_22k.pth',
    ),
    'swin_large_patch4_window7_224_22k': _cfg(
        url='https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_large_patch4_window7_224_22k.pth',
    ),
    'swin_large_patch4_window12_384_22k': _cfg(
...
def create_new_image_size(img_size, super_img_dim, window_size):
    h, w = img_size * super_img_dim[0], img_size * super_img_dim[1]
    new_h, new_w = h, w
    dim = 32 * window_size
    ...
    return (new_h//super_img_dim[0], new_w//super_img_dim[1])
...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, duration=8, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.frame_padding = self.duration % super_img_rows if self.image_mode is True else 0
        ...
        print ('---------------------------------------')
        print ('duration:', self.duration, 'frame padding:', self.frame_padding, 'image_size:', self.img_size, 'patch_size:', patch_size, 'super_img_size:', (super_img_rows, self.duration//super_img_rows), 'ape:', self.ape)

        self.patch_embed = PatchEmbed(
            img_size=super_img_size, patch_size=patch_size, in_chans=in_chans, embed_dim=embed_dim,
...
#            trunc_normal_(self.absolute_pos_embed, std=.02)
    ...
    def create_image_pos_embed(self):
        ...
        rows = img_rows // self.super_img_rows
        cols = img_cols // (self.duration // self.super_img_rows)
        img_pos_embed = torch.zeros(img_rows, img_cols, T).cuda()
         #print (self.duration, T, img_rows, img_cols, rows, cols)
        for i in range(self.duration):
            r_indx = (i // self.super_img_rows) * rows
            c_indx = (i % self.super_img_rows) * cols
...
def _create_vision_transformer(variant, pretrained=False, pretrained_window_size=7, **kwargs):
    ...
    img_size = kwargs.pop('image_size', default_img_size)
...
@register_model
def sifar_base_patch4_window7_224(pretrained=False, **kwargs):
    ...
    model_kwargs = dict(patch_size=patch_size, embed_dim=embed_dim, depths=depths, num_heads=num_heads, mlp_ratio=mlp_ratio,
...
@register_model
def sifar_base_patch4_window7_224_3x3_big(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_base_patch4_window7_224_4x4_big(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_base_patch4_window7_224_5x5_big(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_base_patch4_window14_224_3x3(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_base_patch4_window12_192_4x4(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_base_patch4_window12_192_5x5(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_base_patch4_window14_224_4x4(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_base_patch4_window14_224_5x5(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_base_patch4_window12_384(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
    ...
    model_kwargs = dict(patch_size=patch_size, img_size=img_size, window_size=window_size, embed_dim=embed_dim, depths=depths, num_heads=num_heads, mlp_ratio=mlp_ratio,
                        use_checkpoint=use_checkpoint, ape=ape, bottleneck=bottleneck, **kwargs)
    print(model_kwargs)
    model = _create_vision_transformer('swin_base_patch4_window12_384_22k', pretrained=pretrained, pretrained_window_size=12, **model_kwargs)
    return model

@register_model
def sifar_base_patch4_window15_320(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_base_in1k_patch4_window7_224(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
    ...
    model_kwargs = dict(patch_size=patch_size, embed_dim=embed_dim, depths=depths, num_heads=num_heads, mlp_ratio=mlp_ratio,
                        use_checkpoint=use_checkpoint, ape=ape, bottleneck=bottleneck, **kwargs)
    print(model_kwargs)
    model = _create_vision_transformer('swin_base_in1k_patch4_224', pretrained=pretrained, pretrained_window_size=7, **model_kwargs)
    return model

@register_model
def sifar_base_patch4_window20_320_4x4(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_base_patch4_window24_384_4x4(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
'''
@register_model
def sifar_large_patch4_window7_224(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
    ...
    model_kwargs = dict(patch_size=patch_size, embed_dim=embed_dim, depths=depths, num_heads=num_heads, mlp_ratio=mlp_ratio,
                        use_checkpoint=use_checkpoint, ape=ape, bottleneck=bottleneck, **kwargs)
    print(model_kwargs)
    model = _create_vision_transformer('swin_large_patch4_window7_224_22k', pretrained=pretrained, pretrained_window_size=7, **model_kwargs)
    return model

@register_model
def sifar_large_patch4_window14_224_3x3(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_large_patch4_window14_224_4x4(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
...
@register_model
def sifar_large_patch4_window12_192_3x3(pretrained=False, **kwargs):
    """ ViT-Base (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
    ImageNet-1k weights fine-tuned from in21k @ 224x224, source https://github.com/google-research/vision_transformer.
    """
    temporal_module_name = kwargs.pop('temporal_module_name', None)
