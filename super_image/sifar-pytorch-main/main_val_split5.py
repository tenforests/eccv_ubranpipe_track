...
def main(args):
    ...
    for  i in range(begin,end):
        for model_path in Path(args.output_dir+"/split"+str(i)+"/").rglob("*.pth"):
        ...
        #    std = IMAGENET_DEFAULT_STD
            ...
            if args.initial_checkpoint:
                ...
                # checkpoint = torch.load(args.initial_checkpoint+"split"+str(i)+"/epoch9_checkpoint.pth", map_location='cpu')
                    ...
                    for images,filename in data_loader_test:
                        ...
                        for j in range(0,batch_size):
                            ...
                            if x == 0:
                                ...
                                outputs[filename[j]] = tmp.tolist()
                with open(str(output_dir)+'/'+model_path.stem+'_test_result.json', 'w') as f:
                    json.dump(outputs, f)
                print("eval done")
